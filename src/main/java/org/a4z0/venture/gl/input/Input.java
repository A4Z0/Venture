package org.a4z0.venture.gl.input;
...
public final class Input {
    ...
    */
    ...
    public static boolean isKeyDown(int GL_KEY_CODE) {
        return GLFW.glfwGetKey(Venture.WINDOW.getID(), GL_KEY_CODE) == 1;
    }
    ...
    */
    ...
    public static boolean isButtonDown(int GL_BUTTON_CODE) {
        return GLFW.glfwGetMouseButton(Venture.WINDOW.getID(), GL_BUTTON_CODE) == 1;
    }
    ...
    */
    ...
    public static double getMouseX() {
        ...
        glfwGetCursorPos(Venture.WINDOW.getID(), DOUBLE_BUFFER, null);
    ...
    */
    ...
    public static double getMouseY() {
        DoubleBuffer DOUBLE_BUFFER = BufferUtils.createDoubleBuffer(1);
        glfwGetCursorPos(Venture.WINDOW.getID(), null, DOUBLE_BUFFER);
